...
type ArticleContextType = {
  ...
  filterArticlesByQuery: (query: QueryType | null) => void;
  setQuery: (query: QueryType | null) => void;
};

const ArticleContext = createContext({} as ArticleContextType);

interface IArticleContextProvider {
  children: React.ReactNode;
}

export const useArticleContext = () => useContext(ArticleContext);

export const ArticleContextProvider: FC<IArticleContextProvider> = ({
  children,
}) => {
  ...
  const filterArticlesByQuery = (query: QueryType | null): void => {
    const filteredArticles = articles.filter((a) =>
      query?.name === "all" ? true : a.text.includes(query?.name) && true
    );
  ...
  return (
    <ArticleContext.Provider
      value={{ filteredArticles, filterArticlesByQuery, setQuery }}
    >
      {children}
    </ArticleContext.Provider>
  );
